...
<div class="report-container">
    ...
    <div class="signature-section">
        <div class="sig-column">
            ...
            <div style="text-align: center; margin-top: 5px;">{{ $investigation->policeCase->assignedOfficer->name ?? '________________' }}</div>
        </div>
        <div class="sig-column">
            <div class="sig-line">Taliyaha CID-da (Approval)</div>
            <div style="text-align: center; margin-top: 5px;">Magaca & Saxiixa</div>
        </div>
    </div>
