            ...
            <tr style="border-bottom: 1px solid var(--border-soft);">
                <td style="padding: 1rem;">
                    <div style="display: flex; align-items: center; gap: 0.8rem;">
                        @if($commander->user->profile_image)
                            <img src="{{ asset('storage/' . $commander->user->profile_image) }}" style="width: 35px; height: 35px; border-radius: 50%; object-fit: cover;">
                        @else
                            <img src="https://ui-avatars.com/api/?name={{ urlencode($commander->user->name) }}&size=35&background=random" style="border-radius: 50%;">
                        @endif
